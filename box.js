...
(function() {
  ...
  Box = (function() {
    function Box(container, opts) {
      ...
      this.box.find(".face").css("position", "absolute");
    ...
    Box.prototype.setCubeTransform = function() {
